...
const keys: Key[] = [
    ...
    new ExtraTallKey(new PlainSymbolKey("⎈", thumbKeyRow, 'helm_tall')),
    new ExtraTallKey(new PlainSymbolKey("↵", thumbKeyRow, 'return')),
    new ExtraTallKey(new PlainSymbolKey("⌫", thumbKeyRow, 'backspace')),
    ...
    new PlainSymbolKey('⎋', thumbKeyRow, 'escape'),
    new PlainSymbolKey('⌦', thumbKeyRow, 'delete'),
    new PlainSymbolKey('⎀', thumbKeyRow, 'insert'),
    new PlainSymbolKey('⎈', bottomRow, 'helm'),
